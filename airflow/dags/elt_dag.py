...
t2 = DockerOperator(
    ...
    network_mode="brigde",
    mounts=[
        Mount(source='/mnt/d/code/project/ELK data from postgres database/custom_postgres',
              target='/opt/dbt', type='bind'),
        Mount(source='/mnt/d/code/project/ELK data from postgres database/.dbt',
